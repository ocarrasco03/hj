...
use App\Packages\LogViewer\LogViewer;
...
class LogViewerController extends Controller
{
    ...
    /**
     * @var \Packages\LogViewer\LogViewer
     */
    private $log_viewer;
    ...
    public function index()
    {
        ...
        return Inertia::render('Cms/Support/Log', ['logs' => $data]);
    }
    ...
    {
        return Crypt::encrypt($request->input('l'));
    }
}
