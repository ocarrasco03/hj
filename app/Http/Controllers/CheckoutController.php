...
class CheckoutController extends Controller
{
    ...
    public function refund(Order $order, Status $status)
    {
        ...
        try {
            switch ($order->payment_provider) {
                case 'bbva':
                    ...
                    $refund = [
                        'description' => "Devolución de orden " . $order->id,
                ...
                case 'paypal':
                    $refund = [
                        'note_to_payer' => "Devolución de orden " . $order->id,
                        'amount' => [
        ...
        return redirect()->back()->with(['toast' => ['type' => 'success', 'message' => 'Tu orden ha sido reembolsada exitosamente tu pago. Tu banco puede tardar hasta 15 días en finalizar la transacción.']]);
    }
