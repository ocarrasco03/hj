<template>
    <div class="card mt-5 p-5">
        <div class="tabs wizard wizard-style-2">
            <nav class="tab-nav">
                <button
                    class="nav-link h5 active"
                    data-toggle="tab"
                    data-target="#tab-style-2-1"
                >
                    Step 1
                ...
                <button
                    class="nav-link h5"
                    data-toggle="tab"
                    data-target="#tab-style-2-2"
                >
                    Step 2
                    <small>Second tep description</small>
                </button>
                <button
                    class="nav-link h5"
                    data-toggle="tab"
                    data-target="#tab-style-2-3"
                >
                    Step 3
            ...
            <div class="tab-content mt-8">
                <div id="tab-style-2-1" class="collapse open">
                    <form>
                        <div class="mb-5">
                            <label class="label block mb-2" for="email-2"
                                >Email</label
                            >
                            <input
                                id="email-2"
                        ...
                        <div class="mb-5">
                            <label class="label block mb-2" for="password-2"
                                >Password</label
                            >
                            <input
                                id="password-2"
                ...
                <div id="tab-style-2-2" class="collapse">Step 2 Content</div>
                <div id="tab-style-2-3" class="collapse">Step 3 Content</div>
            </div>
            <div class="mt-5">
                <div class="btn-group">
                    <button
                        type="button"
                        class="btn btn_primary uppercase"
                        data-toggle="wizard"
...
<script setup>
// import WizardButton from "@/Components/Cms/WizardButton";
// import WizardStep from "@/Components/Cms/WizardStep";
...
const addTab = (item) => {
    const index = page.$slots.default.indexOf(item.$vnode);
};
