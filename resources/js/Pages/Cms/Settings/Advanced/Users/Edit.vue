                        ...
                        >
                            <thead>
                                <tr class="text-admin">
                                    ...
                                    <th class="w-20 text-center">Actualizar</th>
                                    <th class="w-20 text-center">Eliminar</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-if="form.role === 'Super Administrador'">
                                    <td
                                        colspan="5"
                                        class="text-center font-medium"
                                    >
                                        Los permisos de Super Administrador no
                                    ...
                                    <td>
                                        ...
                                        >
                                            <input
                                                ...
                                                :value="
                                                    module.prefix + '.create'
                                                "
                                                :disabled="form.role === null"
                                            />
                                            <span></span>
                                        </label>
                                    </td>
