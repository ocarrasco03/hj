...
const showNote = (id) => {
    let target = document.getElementById(`notes-${id}`)
    ...
    <div class="container py-3 flex flex-col md:flex-row">
        ...
        <section id="results" class="flex-1">
            <div class="flex items-center justify-center py-3">
                <h1 class="uppercase font-bold text-2xl">Volkswagen Bora</h1>
            </div>
            <div
                ...
                <div class="p-3 flex flex-col flex-1">
                    ...
                    <div class="flex items-center justify-between flex-1">
                        <h3 class="font-bold">$ {{ item.price }} <small>MXN</small>
                            <a class="hover:text-primary-900 text-secondary-500 cursor-pointer group" @onclick="showNote(item.id)">
                                ...
                                <div class="bg-secondary-500 text-white p-3 absolute bg-opacity-90 max-w-xs invisible group-hover:visible rounded z-10 ml-32 -mt-6 text-xs" :id="`notes-${item.id}`" >
                                    <ul>
                                        <li>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quidem accusamus laudantium inventore optio atque blanditiis doloribus perferendis, ex numquam quisquam asperiores porro quia amet! Asperiores reiciendis fuga nam quis similique.</li>
