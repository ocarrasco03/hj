...
use Tests\Feature\Shoppingcart\Fixtures\BuyableProduct;
use Tests\Feature\Shoppingcart\Fixtures\ProductModel;
use Tests\TestCase;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \App\Packages\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    public function it_can_calculate_tax_based_on_the_default_tax_rate_in_the_config()
    {
        ...
        $this->assertEquals(1.60, $cartItem->tax);
    }
    ...
    public function it_can_return_the_calculated_tax_formatted()
    {
        ...
        $this->assertEquals('1.600,00', $cartItem->tax(2, ',', '.'));
    }
    ...
    public function it_can_calculate_the_total_tax_for_all_cart_items()
    {
        ...
        $this->assertEquals(8.00, $cart->tax);
    }
    ...
    public function it_can_return_formatted_total_tax()
    {
        ...
        $this->assertEquals('800,00', $cart->tax(2, ',', '.'));
    }
    ...
    public function it_can_return_cartItem_formated_numbers_by_config_values()
    {
        ...
        $this->assertEquals('2320,00', $cartItem->priceTax());
        $this->assertEquals('4000,00', $cartItem->subtotal());
        $this->assertEquals('4640,00', $cartItem->total());
        $this->assertEquals('320,00', $cartItem->tax());
        $this->assertEquals('640,00', $cartItem->taxTotal());
    }
     ...
     *
     * @return \App\Packages\Shoppingcart\Cart
     */
