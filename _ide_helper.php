...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Packages\Shoppingcart\Cart $instance */
         ...
         * @param float $weight
         * @param array $options
         * @return \App\Packages\Shoppingcart\CartItem 
         * @static 
         */ 
         ...
         * Add an item to the cart.
         *
         * @param \App\Packages\Shoppingcart\CartItem $item Item to add to the Cart
         * @param bool $keepDiscount Keep the discount rate of the Item
         * @param bool $keepTax Keep the Tax rate of the Item
         * @param bool $dispatchEvent
         * @return \App\Packages\Shoppingcart\CartItem The CartItem
         * @static 
         */ 
        ...
        public static function macro($name, $macro)
        {
                        \App\Packages\Shoppingcart\Cart::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \App\Packages\Shoppingcart\Cart::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \App\Packages\Shoppingcart\Cart::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {
                        \App\Packages\Shoppingcart\Cart::flushMacros();
        }
...
namespace  { 
            ...
            class Cart extends \App\Packages\Shoppingcart\Facades\Cart {}
